...
install_xcframework "${PODS_ROOT}/SAPFoundation/SAPFoundation.xcframework" "SAPFoundation" "framework" "ios-arm64_x86_64-maccatalyst" "ios-arm64" "ios-arm64_x86_64-simulator"

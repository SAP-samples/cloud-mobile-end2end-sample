...
install_xcframework "${PODS_ROOT}/SAPFioriFlows/SAPFioriFlows.xcframework" "SAPFioriFlows" "framework" "ios-arm64" "ios-arm64_x86_64-simulator" "ios-arm64_x86_64-maccatalyst"

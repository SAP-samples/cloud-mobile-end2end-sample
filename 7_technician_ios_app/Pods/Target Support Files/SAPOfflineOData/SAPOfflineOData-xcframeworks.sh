...
install_xcframework "${PODS_ROOT}/SAPOfflineOData/SAPOfflineOData.xcframework" "SAPOfflineOData" "framework" "ios-arm64" "ios-x86_64-simulator" "ios-x86_64-maccatalyst"

...
// Design-Controls
//
// Created by SAP Cloud Platform SDK for iOS Assistant application on 16/07/19
//
...
@UIApplicationMain
class AppDelegate: UIResponder, UIApplicationDelegate, ConnectivityObserver, UNUserNotificationCenterDelegate {
    var window: UIWindow?

...
public class MachineListener extends com.sap.cloud.server.odata.DefaultEntityListener {
    private com.sap.odata.MainServlet servlet;
    private com.sap.odata.proxy.OdataService service;

    public MachineListener(com.sap.odata.MainServlet servlet, com.sap.odata.proxy.OdataService service) {
        super();
    ...
    public void beforeSave(EntityValue entityValue) {
        com.sap.odata.proxy.Machine entity = (com.sap.odata.proxy.Machine)entityValue;
